...
<div class="container" style="padding-top: 2rem;">
        ...
        <div class="grid-3" style="margin-bottom: 3rem;">
            ...
            <div class="card" style="display: flex; flex-direction: column; justify-content: space-between; height: 100%;">
                <div>
                    ...
                    <h3 style="font-size: 1.1rem; font-weight: 700; margin-bottom: 0.75rem; line-height: 1.4; color: var(--text);">
                        {{ $actu->titre_fr }}
                    </h3>
                ...
                {{-- Card Footer --}}
                <div style="border-top: 1px solid var(--border); padding-top: 0.75rem; margin-top: 1rem; display: flex; justify-content: space-between; align-items: center; font-size: 0.775rem; color: var(--text-muted);">
                    <div>
    ...
    @else
        <div class="card text-center" style="padding: 4rem 1rem; margin-bottom: 4rem;">
            ...
            <h2 style="font-size: 1.25rem; font-weight: 700; color: var(--primary); margin-bottom: 0.5rem;">Aucune actualité disponible</h2>
