...
<div class="container" style="padding-top: 2rem;">
    ...
    <div class="grid-2" style="margin-bottom: 4rem; align-items: center;">
        ...
        <div class="card" style="border-left: 5px solid var(--color-accent);">
            <h3 style="font-size: 1.25rem; margin-bottom: 0.75rem; color: var(--color-primary);">Modèles Halieutiques & Dynamique des Pêches</h3>
            <p style="font-size: 0.9rem; color: var(--color-text-muted); line-height: 1.7;">
    ...
    <div style="margin-bottom: 4rem;">
        <h2 style="font-size: 1.5rem; margin-bottom: 2rem; text-align: center; color: var(--color-primary);">Nos Méthodes Scientifiques</h2>
