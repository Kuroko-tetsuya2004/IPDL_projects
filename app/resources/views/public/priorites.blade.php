...
<div class="container" style="padding-top: 2rem;">
    ...
    <div style="display: flex; flex-direction: column; gap: 3rem; margin-bottom: 4rem;">
        ...
        <div class="card" style="display: grid; grid-template-columns: 80px 1fr; gap: 1.5rem; border-left: 5px solid var(--primary-light);">
            <div style="font-size: 3rem; text-align: center; display: flex; align-items: flex-start; justify-content: center; padding-top: 0.5rem;">
                🦠
            </div>
            <div>
                <h2 style="font-size: 1.4rem; font-weight: 700; margin-bottom: 0.75rem; color: var(--primary);">
                ...
                <p style="color: var(--text-muted); font-size: 0.925rem; line-height: 1.7; margin-bottom: 1rem;">
        ...
        <div class="card" style="display: grid; grid-template-columns: 80px 1fr; gap: 1.5rem; border-left: 5px solid var(--accent);">
            <div style="font-size: 3rem; text-align: center; display: flex; align-items: flex-start; justify-content: center; padding-top: 0.5rem;">
                🌊
            </div>
            <div>
        ...
        <div class="card" style="display: grid; grid-template-columns: 80px 1fr; gap: 1.5rem; border-left: 5px solid var(--success);">
            <div style="font-size: 3rem; text-align: center; display: flex; align-items: flex-start; justify-content: center; padding-top: 0.5rem;">
                🧬
            </div>
            <div>
