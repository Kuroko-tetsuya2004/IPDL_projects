...
<div class="container" style="padding-top: 2rem;">
    ...
    <div class="grid-3" style="margin-bottom: 4rem;">
        ...
        <div class="card" style="border-top: 4px solid {{ $axe->couleur_hex ?? '#1E3A8A' }}; display: flex; flex-direction: column; justify-content: space-between; height: 100%;">
            <div>
                <h2 style="font-size: 1.25rem; font-weight: 700; color: {{ $axe->couleur_hex ?? 'var(--primary)' }}; margin-bottom: 0.25rem; font-family: 'Outfit', sans-serif;">
                    {{ $axe->nom_fr }}
                </h2>
                @if($axe->nom_en)
            ...
            <div>
                {{-- Responsable --}}
                @if($axe->responsable)
                    <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1.25rem; padding: 0.75rem; background: #f8fafc; border-radius: var(--radius-sm); border: 1px solid var(--border);">
                        ...
                        <div>
                            <div style="font-size: 0.825rem; font-weight: 700; color: var(--text);">
                ...
                {{-- Statistiques --}}
                <div style="display: flex; justify-content: space-between; align-items: center; font-size: 0.8rem; font-weight: 600; color: var(--text-muted); border-top: 1px solid var(--border); padding-top: 0.75rem;">
