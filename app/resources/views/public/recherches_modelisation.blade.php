...
<div class="container" style="padding-top: 2rem;">
    ...
    <div class="grid-2" style="margin-bottom: 4rem; align-items: center;">
        <div>
            <h2 style="font-size: 1.5rem; margin-bottom: 1rem; color: var(--color-primary);">
            ...
            <p style="color: var(--color-text-muted); font-size: 0.95rem; line-height: 1.7;">
        ...
        <div class="card" style="border-left: 5px solid var(--color-primary-light);">
            <h3 style="font-size: 1.25rem; margin-bottom: 0.75rem; color: var(--color-primary);">La Plateforme GAMA</h3>
    ...
    <div style="margin-bottom: 4rem;">
        <h2 style="font-size: 1.5rem; margin-bottom: 2rem; text-align: center; color: var(--color-primary);">Principales Applications chez UMMISCO</h2>
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 1.5rem;">
            <div class="card">
                <h3 style="font-size: 1.1rem; margin-bottom: 0.5rem; color: var(--color-primary-light);">🏙️ Gestion des Risques Urbains</h3>
            ...
            <div class="card">
                <h3 style="font-size: 1.1rem; margin-bottom: 0.5rem; color: var(--color-primary-light);">🌲 Agro-écosystèmes & Gestion de l'Eau</h3>
                <p style="font-size: 0.875rem; color: var(--color-text-muted); line-height: 1.6;">
            ...
            <div class="card">
                <h3 style="font-size: 1.1rem; margin-bottom: 0.5rem; color: var(--color-primary-light);">🦠 Propagation Épidémique Spatiale</h3>
                <p style="font-size: 0.875rem; color: var(--color-text-muted); line-height: 1.6;">
