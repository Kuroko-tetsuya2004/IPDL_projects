...
<div class="container" style="padding-top: 2rem;">
    ...
    <div class="grid-2" style="margin-bottom: 4rem;">
        ...
        <div class="card" style="border-top: 4px solid var(--color-primary-light);">
            ...
            <h3 style="font-size: 1.2rem; margin-bottom: 0.75rem; color: var(--color-primary);">Logiciels & Outils</h3>
        ...
        <div class="card" style="border-top: 4px solid var(--color-accent);">
            <div style="font-size: 2rem; margin-bottom: 0.75rem;">📊</div>
            <h3 style="font-size: 1.2rem; margin-bottom: 0.75rem; color: var(--color-primary);">Expertise & Décision</h3>
            <p style="font-size: 0.9rem; color: var(--color-text-muted); line-height: 1.6; margin-bottom: 1.25rem;">
