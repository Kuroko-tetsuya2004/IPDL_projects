    ...
    <div class="grid-2" style="margin-bottom: 4rem;">
        ...
        <div>
            <h2 style="font-size: 1.5rem; margin-bottom: 1rem; position: relative; padding-left: 1rem; display: flex; align-items: center;">
                <span style="position: absolute; left: 0; top: 0; bottom: 0; width: 4px; background: var(--color-primary-light); border-radius: 2px;"></span>
                Qui sommes-nous ?
            </h2>
            <p style="margin-bottom: 1.25rem; color: var(--color-text); font-weight: 500;">
            ...
            <p style="margin-bottom: 1.25rem; color: var(--color-text-muted); font-size: 0.95rem;">
        ...
        <div class="card" style="background: white; border-radius: var(--radius); display: flex; flex-direction: column; justify-content: center; gap: 1.5rem;">
            <h3 style="font-size: 1.2rem; font-weight: 700; margin-bottom: 0.5rem; color: var(--color-primary);">
                Tutelles & Partenariats Académiques
            </h3>
            
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                <div style="padding: 1rem; border: 1.5px solid var(--color-border); border-radius: var(--radius-sm); text-align: center;">
                    <div style="font-weight: 800; font-size: 1.1rem; color: var(--color-primary-light);">CNRS</div>
                    <div style="font-size: 0.75rem; color: var(--color-text-muted);" class="mt-1">Centre National de la Recherche Scientifique (France)</div>
                </div>
                <div style="padding: 1rem; border: 1.5px solid var(--color-border); border-radius: var(--radius-sm); text-align: center;">
                    <div style="font-weight: 800; font-size: 1.1rem; color: var(--color-primary-light);">IRD</div>
                    <div style="font-size: 0.75rem; color: var(--color-text-muted);" class="mt-1">Institut de Recherche pour le Développement (France)</div>
                </div>
                <div style="padding: 1rem; border: 1.5px solid var(--color-border); border-radius: var(--radius-sm); text-align: center;">
                    <div style="font-weight: 800; font-size: 1.1rem; color: var(--color-primary-light);">Sorbonne</div>
                    <div style="font-size: 0.75rem; color: var(--color-text-muted);" class="mt-1">Sorbonne Université (Paris, France)</div>
                </div>
                <div style="padding: 1rem; border: 1.5px solid var(--color-border); border-radius: var(--radius-sm); text-align: center;">
                    <div style="font-weight: 800; font-size: 1.1rem; color: var(--color-primary-light);">UCAD</div>
                    <div style="font-size: 0.75rem; color: var(--color-text-muted);" class="mt-1">Université Cheikh Anta Diop (Dakar, Sénégal)</div>
                </div>
            </div>
        </div>
    </div>
