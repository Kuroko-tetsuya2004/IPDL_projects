...
<div class="container" style="padding-top: 2rem;">
    ...
    <div class="grid-2" style="margin-bottom: 4rem; gap: 2.5rem;">
        ...
        <div class="card" style="background: white;">
            <h2 style="font-size: 1.35rem; margin-bottom: 1.5rem; color: var(--color-primary);">Envoyer un Message</h2>
            ...
            <form method="POST" action="{{ route('contact.submit') }}">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div class="form-group">
                        <label for="nom">Nom complet <span style="color:var(--color-danger)">*</span></label>
                        <input type="text" name="nom" id="nom" class="form-control" placeholder="Ex: Jean Dupont" required value="{{ old('nom') }}">
                    </div>
                    <div class="form-group">
                        <label for="email">Adresse email <span style="color:var(--color-danger)">*</span></label>
                ...
                <div class="form-group">
                    <label for="sujet">Sujet du message <span style="color:var(--color-danger)">*</span></label>
                ...
                <div class="form-group">
                    <label for="message">Votre message <span style="color:var(--color-danger)">*</span></label>
        ...
        <div style="display: flex; flex-direction: column; gap: 2rem;">
            <div class="card" style="border-left: 5px solid var(--color-primary-light);">
                <h3 style="font-size: 1.2rem; margin-bottom: 0.75rem; color: var(--color-primary);">📍 Localisation Principale</h3>
                <p style="font-size: 0.925rem; color: var(--color-text); font-weight: 600; margin-bottom: 0.25rem;">
            ...
            <div class="card" style="border-left: 5px solid var(--color-accent);">
                <h3 style="font-size: 1.2rem; margin-bottom: 0.75rem; color: var(--color-primary);">📧 Secrétariat Scientifique</h3>
                <p style="font-size: 0.875rem; color: var(--color-text-muted); line-height: 1.6; margin-bottom: 0.5rem;">
                    Pour toute demande administrative, académique ou relative au suivi des publications :
                </p>
                <p style="font-size: 1rem; font-weight: 700; color: var(--color-primary-light);">
                    admin@ummisco.ucad.sn
                </p>
            </div>

            <div class="card" style="border-left: 5px solid var(--color-success);">
                <h3 style="font-size: 1.2rem; margin-bottom: 0.75rem; color: var(--color-primary);">👥 Autres Implantations</h3>
                <p style="font-size: 0.875rem; color: var(--color-text-muted); line-height: 1.6;">
