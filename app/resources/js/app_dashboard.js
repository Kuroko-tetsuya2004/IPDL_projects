...
// ── Application Inertia (DASHBOARD) ───────────────────────────────────────────
createInertiaApp({
  title: (title) => title ? `${title} — Dashboard UMMISCO` : 'Dashboard UMMISCO',
  resolve: (name) =>
    resolvePageComponent(`./Pages/${name}.vue`, import.meta.glob('./Pages/{Dashboard,Content,Dataset,Notification,User,Auth}/**/*.vue')),
